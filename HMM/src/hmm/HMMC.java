...
public class HMMC {
	 ...
	 */
	   public static void solve_hmmc() {
           ...
           double[][] data_A = {{0.54, 0.26, 0.20}, {0.19, 0.53, 0.28}, {0.22, 0.18, 0.6}};
           double[][] data_B = {{0.5, 0.2, 0.11, 0.19}, {0.22, 0.28, 0.23, 0.27}, {0.19, 0.21, 0.15,0.45}};
           double[][] data_pi = {{0.3,0.2,0.5 }};
           
           //readInput(A,B,pi);
           try {
               //System.out.println("Reading input...");
               //reader = new BufferedReader(new InputStreamReader(System.in));
               reader = new BufferedReader(new FileReader("src/hmm/hmm_c_N1000.in"));
               //reader = new BufferedReader(new FileReader("src/hmm/hmm_c_N10000.in"));
